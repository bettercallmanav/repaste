...
export const ClipCaptureCommand = Schema.Struct({
  ...
  imageAssetPath: Schema.optional(Schema.NullOr(Schema.String)),
  imageWidth: Schema.optional(Schema.NullOr(NonNegativeInt)),
...
export const AppSettings = Schema.Struct({
  ...
  backgroundRunning: Schema.Boolean,
  startAtLogin: Schema.Boolean,
  closeToTray: Schema.Boolean,
  quitToBackground: Schema.Boolean,
